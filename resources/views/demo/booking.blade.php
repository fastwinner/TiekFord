        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="service" class="nav-item nav-link active">reservation</a>
                                ...
                                @auth
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <h5 class="text-white mb-4"> {{Auth::user()->name}} {{Auth::user()->first_name}} </h5>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <h5 class="text-white mb-4"> {{Auth::user()->email}} </h5>
                                        </div>
                                    </div>
                                @endauth
                                <div class="col-md-6">
                                    <div class="form-floating date">
                                        <input type="date" class="form-control datetimepicker-input" id="date" name="date" placeholder="Date" />
                                        <label for="date">Date</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating date">
                                        <input type="time" class="form-control datetimepicker-input" id="time" name="time" placeholder="time" />
                                        <label for="time">heure</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control datetimepicker-input" id="NombrePersonne" name="NombrePersonne" placeholder="NombrePersonne"/>
