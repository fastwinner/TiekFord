                            ...
                            <div class="row g-4">
                                @foreach($donnees as $element)
                                    ...
                                    if (Auth::user())
                                    {
                                        ...
                                        if ($panier=(App\Models\Panier::where('id', $id_user)->where('id_plat',$element->id_plat)->where('statut', 0))->first())
                                        {
                                            $qte=$panier->quantité;
                                        }
                                        else {
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>{{$element->nom_plat}}</span>
                                                    <span class="text-primary">{{$element->prix_plat}} FCFA</span>
                                                </h5>
                                                <div class="row">
                                                    <div class="col">
                                                    ...
                                                    @if ($qte)
                                                        <div class="col-1 me-5">
                                                            <button class="btn btn-primary rounded-circle">{{$qte}}</button>    
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
