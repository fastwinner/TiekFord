                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" required value={{Auth::user()->name}} id="name" name="name" placeholder="">
                                <label for="name">Nom</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" required value={{Auth::user()->first_name}} id="first_name" name="first_name" placeholder="">
                                <label for="first_name">Prenoms</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="Email" class="form-control" required value={{Auth::user()->email}} id="email" name="email" placeholder="">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" required id="LieuLivraison" name="LieuLivraison" placeholder="">
                                <label for="LieuLivraion">Lieu de livraion </label>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" required id="MoyenPaiement" name="MoyenPaiement" placeholder="">
