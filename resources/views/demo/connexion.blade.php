    ...
    <div class="container-fluid vh-100 bg-dark hero-header d-flex align-items-center">
        <div class="col-6">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                <h1 class="section-title ff-secondary text-start text-primary fw-normal">Connexion</h1>
                <form action="" method="POST" >
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            @error('password')
                            <div  class="alert alert-danger" role="alert">
                             mot de passe trop court (au moins 4 caractères)
                            </div>
                            @enderror
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit">Se connecter</button>
                            <p class="text-center pt-4"><a href="#" class="text-light">mot de passe oublié ?</a></p>
                            <p class="text-center">Vous n'avez pas de compte ? | <a href="inscription">Inscrivez vous !</a></p>
                        </div>
                    </div>
                </form>
            </div>
